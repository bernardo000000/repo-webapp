...
const DescargarPDF = ({ proyecto, cliente, acuerdo }) => {
    const handleDownloadPDF = () => {
        ...
        pdf.setFontSize(10);
        pdf.text("Este documento es para confirmar que los datos del proyecto,de usted como cliente y acuerdo iniciales respecto al", 10, 20);
        ...
        pdf.setFontSize(12);
          pdf.text("Datos de Transferencia: S y V Consultores ", 10, pdf.autoTable.previous.finalY + 10);
          pdf.setFontSize(10);
          const acuerdoData = [
        ...
        // Texto de despedida
        pdf.setFontSize(10);
        pdf.text("Si encuentra algún error en los datos proporcionados, le rogamos que se comunique de inmediato con nosotros para que", 10, pdf.autoTable.previous.finalY + 6);
        pdf.text("podamos rectificarlo y realizar las correcciones pertinentes. Agradecemos de antemano su confianza en nuestra empresa.", 10, pdf.autoTable.previous.finalY + 9);
    
        // Guardar el PDF
        pdf.save("detalles_proyecto.pdf");
      };
  return (
    <button onClick={handleDownloadPDF} className="bg-orange-500 hover:bg-orange-700 text-white font-bold py-2 px-4 rounded">
      Descargar Factura
    </button>
  );
};
